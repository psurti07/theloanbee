		...
		function convertIntoCustomer($cardno, $userData, $cardData, $orderAmount, $txnId, $accType, $slug, $prefix, $offerpage) {
		    try {
                ...
                try
                {
                    ...
                    $subject = (($accType == 2)
                        ? 'Congratulations! Payment for TheLoanbee’s Hire Agent plan has been successful.'
                        : (($accType == 3) 
                        ? 'Congratulations! Payment for TheLoanbee’s Self-Apply plan has been successful.'
                        : 'Congratulations! Payment Successful for TheLoanbee’s Self-Apply Plan.'));
